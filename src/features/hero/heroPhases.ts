...
/** 0..1 progress during Mini Transformation where P fades down out and AT fades down in (0.75 -> 0.85). */
...
/** 0..1 progress during Mini Transformation where PHITOPOLIS slides left to AT (0.85 -> 0.95). */
